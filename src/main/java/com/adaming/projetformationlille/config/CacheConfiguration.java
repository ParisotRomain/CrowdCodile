...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.adaming.projetformationlille.domain.Projet.class.getName() + ".profilContributeurs", jcacheConfiguration);
            cm.createCache(com.adaming.projetformationlille.domain.Projet.class.getName() + ".profilSuiveurs", jcacheConfiguration);
            ...
            cm.createCache(com.adaming.projetformationlille.domain.Profil.class.getName() + ".projetPortes", jcacheConfiguration);
